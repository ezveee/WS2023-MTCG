...
public class PostSession : IHttpRequest
{
	...
	public string GetResponse(string request)
	{
		...
		return !LoginDbUser(user, out string authToken)
			? string.Format(Text.HttpResponse_401_Unauthorized, Text.Description_PostSession_401)
			: string.Format(Text.HttpResponse_200_OK_WithContent, Text.Description_PostSession_200, authToken);
	}
